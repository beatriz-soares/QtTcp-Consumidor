...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(652, 566);
        MainWindow->setStyleSheet(QLatin1String("background-color: rgb(243, 243, 243);\n"
"border-bottom-color: rgb(46, 52, 54);"));
        ...
        pushButtonConnect->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
        ...
        pushButtonDisconnect->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
...
"selection-background-color: rgba(29, 28, 28, 159);"));
        ...
        pushButtonUpdate->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
        ...
        horizontalSliderTiming->setStyleSheet(QLatin1String("selection-background-color: rgb(255, 255, 255);\n"
"tick-color: rgb(46, 52, 54);"));
        ...
        horizontalSliderTiming->setTickPosition(QSlider::TicksBothSides);
        ...
        labelTiming->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
        ...
        pushButtonConnectStart->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
        ...
        pushButtonConnectStop->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
